...
define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojchart'],
 function(oj, ko, $) {
    ...
    function BloodPressureSearchViewModel() {
      var self = this;

      self.moduleName = ko.observable();

      var botparams = oj.Router.rootInstance.retrieve();
      self.moduleName('Blood Pressure Search Module for Patient ID - ' + botparams);
     ...
     */
    return new BloodPressureSearchViewModel();
  }
);
